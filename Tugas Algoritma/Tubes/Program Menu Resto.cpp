...
int main ()
{
	...
	cout<<""<<endl<<endl;
	cout<<"============================================="<<endl;
	cout<<"\t\t NGODING caffe(ngopi dingins)'"<<endl;
	...
	if(u==1) {
		...
		cout<<"2. PAKET DOUBLE"<<endl;
		cout<<"3. PAKET TRIPLE"<<endl;
		cout<<"------------------------------------"<<endl;
		cout<<"Pilih Paket Anda [1-3] : ";cin>>kdPilihan1;
		cout<<"------------------------------------"<<endl;
		cout<<""<<endl;
	}
	else
	if(u==2)
	{
		...
		cout<<"------------------------------------"<<endl;
		cout<<"Pilih Paket Anda [1-3] :";cin>>kdPilihan2;
		cout<<"------------------------------------"<<endl;
		cout<<""<<endl;
	}
	else
	if (u==3)
	{
		...
		cout<<"===================================="<<endl;
		cout<<"1. ANEKA JUS"<<endl;
		cout<<"2. ANEKA SODA"<<endl;
		cout<<"3. ANEKA KOPI"<<endl;
		cout<<"------------------------------------"<<endl;
		cout<<" Pilihan Jenis Minuman Anda [1-3] :";cin>>kdPilihan3;
		cout<<"------------------------------------"<<endl;
		cout<<""<<endl;
